...
type TabType = 'workspace' | 'profile' | 'past' | 'components';
...
export function AppShell({ children, activeTab, onTabChange, onLogout }: Props) {
  return (
    <div className="min-h-screen bg-[var(--sys-color-charcoalBackground-base)] flex text-[var(--sys-color-worker-ash-base)] font-sans">
      <SidebarNav activeTab={activeTab} onTabChange={onTabChange} onLogout={onLogout} />
